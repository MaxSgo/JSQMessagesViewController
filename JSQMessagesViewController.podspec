Pod::Spec.new do |s|
	...
	s.homepage = 'https://github.com/SergioWoo/JSQMessagesViewController'
	s.license = 'MIT'
	s.platform = :ios, '7.0'

	s.author = { 'Sergio' => 'SergioWoo@163.com' }
	s.social_media_url = 'https://twitter.com/Sergio'
	...
	s.source = { :git => 'https://github.com/SergioWoo/JSQMessagesViewController.git', :tag => s.version }
